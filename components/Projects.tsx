    ...
    <div className="py-20" id="projects">
      ...
      <div className="flex flex-wrap items-center justify-center p-4 gap-16 mt-10">
        {projects.map(({ id, title, des, img, iconLists, link }) => (
          <div
            key={id}
            className="lg:min-h-[30.5rem] lg:h-[25rem] h-[35rem] flex items-center justify-center sm:w-96  w-[80vw] mx-20"
          >
            <CardContainer className="inter-var">
              <CardBody className="bg-[#13162d] relative group/card border-white/[0.15] w-auto sm:w-[32.5rem] h-auto rounded-xl p-6 border">
                <CardItem
                  translateZ="50"
